...
let user = User(name: "Nik", age: 21, height: 4.24, weight: 65.0, activityLevel: 8)
print("User Profile:")
print("Name: \(user.name)")
print("Age: \(user.age) years")
print("Height: \(user.height) meters")
print("Weight: \(user.weight) kilograms")
print("Activity Level: \(user.activityLevel) (1-10 scale)")
...
print("Distance in feet: \(mile.feet) feet")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let anotherDistance = Distance(meters: 500.0)
print("Distance in meters: \(anotherDistance.meters) meters")
print("Distance in feet: \(anotherDistance.feet) feet")
