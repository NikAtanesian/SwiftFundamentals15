...
struct RunningWorkout {
    ...
    var pace: Double {
        return time > 0 ? time / distance : 0.0
    }
}
...
firstRun.distance = 2396.0 / 1000.0
firstRun.time = 15.3
firstRun.elevation = 94.0
print("I ran \(firstRun.distance) km in \(firstRun.time) minutes and gained \(firstRun.elevation) meters of elevation.")
