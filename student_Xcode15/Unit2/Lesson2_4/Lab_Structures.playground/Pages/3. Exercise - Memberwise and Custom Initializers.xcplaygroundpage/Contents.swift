...
let favoriteBook = Book(title: "The Catcher in the Rye", author: "J.D. Salinger", pages: 214, price: 9.99)
 ...
 */
struct Laptop {
    var screenSize: Int = 13   // Default value of 13 inches
    var repairCount: Int = 0   // Default value of 0 repairs
    var yearPurchased: Int     // No default value, must be provided during initialization
}
let firstLaptop = Laptop(yearPurchased: 2018)
let secondLaptop = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2020)
print("First Laptop: Screen Size: \(firstLaptop.screenSize) inches, Repair Count: \(firstLaptop.repairCount), Year Purchased: \(firstLaptop.yearPurchased)")
print("Second Laptop: Screen Size: \(secondLaptop.screenSize) inches, Repair Count: \(secondLaptop.repairCount), Year Purchased: \(secondLaptop.yearPurchased)")
...
print("Height in centimeters: \(someonesHeight.heightInCentimeters) cm")
...
print("Height in inches: \(myHeight.heightInInches) inches")
print("Height in centimeters: \(myHeight.heightInCentimeters) cm")
