...
let falcon = Spaceship(name: "Falcon", health: 20)
print("Initial health: \(falcon.health)")
falcon.wasHit()
print("Health after hit 1: \(falcon.health)")
falcon.wasHit()
print("Health after hit 2: \(falcon.health)")
falcon.wasHit()
print("Health after hit 3: \(falcon.health)")
