...
defender.weapon = "Cannon"
defender.wasHit()
print("Shield strength after being hit: \(defender.shieldStrength)")
print("Health after being hit: \(defender.health)")
...
print("Health after being hit: \(defender.health)")
defender.wasHit()
print("Shield strength after second hit: \(defender.shieldStrength)")
defender.wasHit()
print("Shield strength after third hit: \(defender.shieldStrength)")
var count = 0
while count < 5 {
    defender.wasHit()
    count += 1
}
print("Shield strength after multiple hits: \(defender.shieldStrength)")
print("Health after multiple hits: \(defender.health)")
